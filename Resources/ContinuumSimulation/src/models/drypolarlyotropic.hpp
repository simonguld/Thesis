#ifndef MODELS_DRYPOLARLYOTROPIC_HPP_
#define MODELS_DRYPOLARLYOTROPIC_HPP_

#include "models.hpp"

class DryPolarLyotropic : public Model
{
protected:
  ...
  /** Model parameters */
  double gamma, xi, friction, Kn, Kp, CC, zeta, Vp, alpha, beta;
  double GammaPhi, Kphi, Aphi, Vphi;
...
public:
  DryPolarLyotropic() = default;
  DryPolarLyotropic(unsigned, unsigned, unsigned);
  DryPolarLyotropic(unsigned, unsigned, unsigned, GridType);
