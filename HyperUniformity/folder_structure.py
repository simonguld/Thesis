...
if run_locally:
    ...
    output_path = '/lustre/astro/kpr279/output'
    log_path = '/groups/astro/kpr279/output/log.txt'
...
def get_relevant_dirs(dirs_all, exp, zeta_c):
    """
...
def main():
    ...
    for j, exp in enumerate(experiment_list):
        ...
        dirs, activity_list = get_relevant_dirs(dirs_all, exp, zeta_c)
