...
## 
im_path1 = "C:\\Users\\Simon\\Documents\\Uni\\Speciale\\Mock data\\valeriias mdck data for simon\\valeriias mdck data for simon\\20.09.22"
im_path2 = "C:\\Users\\Simon\\Documents\\Uni\\Speciale\\Mock data\\valeriias mdck data for simon\\valeriias mdck data for simon\\24.08.22"
...
def main():
    ...
    show_ims1, show_ims2 = False, False
    ...
    if show_ims1:
       ...
       #     print(im_path1 + f"_698\\{file_name}.tif")
        #    im1_list[i].save(im_path1 + f"_698\\{file_name}.tif")
          #  im1_list[i].show()
    if show_ims2:
        for i, im in enumerate(im_list2):
            im2_list[i] = Image.open(im).resize((target_width, target_height))
            file_name = f"im{i}"
          #  im2_list[i].save(im_path2 + f"_698\\{file_name}.tif")
           # im2_list[i].show()
