#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Aug 17 13:44:05 BST 2022      
date_start=`date +%s`
...
export OMP_NUM_THREADS=8
 nice -n 10 /mnt/zfsusers/saraswat/yeomansgroup/Saraswat/Starters_code_2D/./mass runfile/TFS_Base_ST_Elasticity_108.dat -o TwoFluidScripts/Base_ST_Elasticity/Base_ST_Elasticity_108/
